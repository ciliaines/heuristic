...
def Network_Generator(Number_of_edges, Connection_probability) :
    ...
    while ensurer == False :
        ...
        Network_nodes =  list(range(Number_of_edges))
        Network_links = [(0,3),(1,3),(2,3),(3,4),(4,5),(5,6)]
...
def Flows_generator(Number_of_Streams, Number_of_edges) :
    Stream_Source_Destination = []
    Stream_Source_Destination.append([0,6])
    Stream_Source_Destination.append([1,6])
    Stream_Source_Destination.append([2,6])
    Stream_Source_Destination.append([0,3])
